...
def transform_view():
    ...
    #Preprocessing the request data
    #target = 'STOCKA'
    #freq='W'
    #time_series = []
    #data=data1[data1.symbol==target]
    #t0 = str(data.index[0]) 
    #print(t0)
    #print(data.index[-1])
    ...
    data={"start": str("2018-01-01"), "target": []}
    ...
    for k in range(len(prediction_times)):
        prediction_index = pd.DatetimeIndex(start="2018-03-31", freq=freq, periods=prediction_length)
